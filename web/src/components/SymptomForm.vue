  ...
  <form class="space-y-5" @submit.prevent="submit">
    <div>
      ...
      <input
        ...
        class="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-brand focus:outline-none"
      />
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <div>
        ...
        <input
          ...
          class="w-full"
        />
        <div class="text-sm text-slate-500 mt-1">{{ form.severity }}</div>
      </div>
      ...
      <div>
        ...
        <select
          ...
          class="w-full px-4 py-3 rounded-lg border border-slate-300 bg-white focus:ring-2 focus:ring-brand focus:outline-none"
        >
          <option value="">—</option>
    ...
    <button
      ...
      class="w-full py-3 rounded-lg bg-brand text-white font-semibold shadow-md hover:bg-brand-dark transition disabled:opacity-50"
    >
