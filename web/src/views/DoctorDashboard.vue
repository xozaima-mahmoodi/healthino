          ...
          <form class="space-y-3" @submit.prevent="onSubmit">
            ...
            <div class="flex items-stretch gap-2">
              ...
              <button
                ...
                class="group relative isolate overflow-hidden px-5 rounded-lg bg-brand text-white font-semibold shadow-md
              ...
              >
                ...
                ></span>
                <span class="relative z-10">{{ t('doctor.view_history') }}</span>
              </button>
            </div>
